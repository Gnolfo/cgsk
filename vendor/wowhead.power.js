...
if (typeof $WowheadPower == "undefined") {
    var $WowheadPower = new function() {
        ...
        var opt = {
            ...
            threats = {},
            hearthstonecards = {},
            hearthstonemechanics = {},
            hearthstoneachievements = {},
            hearthstonequests = {},
            hearthstonecardbacks = {},
            hearthstoneadventures = {},
            hearthstonebosses = {},
            hearthstonedecks = {},
            showIcon = 1,
            showLogo = 1,
            ...
            TYPE_HEARTHSTONEMECHANIC = 221,
            TYPE_HEARTHSTONEACHIEVEMENT = 222,
            TYPE_HEARTHSTONEQUEST = 223,
            TYPE_HEARTHSTONECARDBACK = 225,
            TYPE_HEARTHSTONEADVENTURE = 227,
            TYPE_HEARTHSTONEBOSS = 228,
            ...
            LOOKUPS = {
                ...
                4: [itemsets, "itemset", "Item Set", "wowhead.com"],
                ...
                22: [garrisonabilities, "garrisonability", "Garrison Ability", "wowhead.com"],
                ...
                221: [hearthstonemechanics, "mechanic", "Hearthstone Mechanic", "hearthhead.com"],
                222: [hearthstoneachievements, "achievement", "Hearthstone Achievement", "hearthhead.com"],
                223: [hearthstonequests, "quest", "Hearthstone Quest", "hearthhead.com"],
                225: [hearthstonecardbacks, "cardback", "Hearthstone Card Back", "hearthhead.com"],
                227: [hearthstoneadventures, "adventure", "Hearthstone Adventure", "hearthhead.com"],
                228: [hearthstonebosses, "boss", "Hearthstone Boss", "hearthhead.com"],
        ...
        function init() {
            if (isRemote) {
                ...
                script.src = (document.location.protocol != "https:" ? "http:" : document.location.protocol) + "//wowjs.zamimg.com/js/basic.js?6";
        ...
        this.init = function() {
            if (isRemote) {
                $WH.ae(head, $WH.ce("link", {
                    type: "text/css",
                    href: (document.location.protocol != "https:" ? "http:" : document.location.protocol) + "//wowcss.zamimg.com/css/basic.css?9",
                    rel: "stylesheet"
                }))
            }
            attachEvent();
        ...
        function scanElement(t, e) {
            ...
            var p = function(m, k, v) {
                if (k == "buff" || k == "sock" || k == "map" || k == "notip" || k == "chal" || k == "twtbc" || k == "twwotlk" || k == "pvp" || k == "noimage") {
                    params[k] = true
                } else {
                    if (k == "rand" || k == "ench" || k == "tink" || k == "lvl" || k == "c" || k == "diff" || k == "diffnew" || k == "upgd" || k == "pwr" || k == "q" || k == "level" || k == "dd" || k == "ddsize") {
                        params[k] = parseInt(v)
                    } else {
                        if (k == "gems" || k == "pcs" || k == "forg" || k == "know" || k == "cri" || k == "bonus" || k == "abil") {
                            params[k] = v.split(":")
                        } else {
                            if (k == "who" || k == "domain") {
                                params[k] = v
            ...
            var isHearthhead = false;
            if (opt.applyto & 1) {
                i1 = 2;
                i2 = 3;
                if (t.href.indexOf("http://") == 0 || t.href.indexOf("https://") == 0) {
                    i0 = 1;
                    m = t.href.match(/^https?:\/\/(.+?)?\.?(?:wowhead|thottbot)\.com(?:\:\d+)?\/\??(item|quest|spell|achievement|itemset|transmog-set|statistic|currency|npc|object|petability|building|follower|garrisonability|mission|ship|threat|hearthstone\/card)=([0-9\.-]+)/);
                    if (!m) {
                        m = t.href.match(/^https?:\/\/(.+?)?\.?(?:hearthhead)\.com(?:\:\d+)?\/\??(card|achievement|cardback|deck|quest|mechanic|adventure|boss)=([0-9]+)/);
                        isHearthhead = !!m
                    }
                    showLogo = 0
                } else {
                    relativeUrl = true;
                    isHearthhead = /\bhearthhead\.com$/.test(location.hostname);
                    m = t.href.match(/()\/\??(item|quest|spell|achievement|itemset|transmog-set|statistic|currency|npc|object|petability|building|follower|garrisonability|mission|ship|threat|hearthstone\/card|card|cardback|deck|mechanic|adventure|boss)=([0-9\.-]+)/);
                    showLogo = 1
                }
            }
            if (m == null && rel && (opt.applyto & 2)) {
                ...
                i1 = 1;
                i2 = 2;
                m = rel.match(/(item|quest|spell|achievement|itemset|transmog-set|statistic|currency|npc|object|petability|building|follower|garrisonability|mission|ship|threat|hearthstone\/card|card|hsachievement|cardback|deck|mechanic|adventure|boss).?([0-9\.-]+)/);
                showLogo = 1;
                relativeUrl = true
            }
            ...
            if (params.bonus && params.bonus.length > 0) {
                for (i = Math.min(16, params.bonus.length - 1); i >= 0; --i) {
                    if (parseInt(params.bonus[i])) {
                        break
                    }
                }++i;
                if (i == 0) {
                    ...
                    if (i < params.bonus.length) {
                        params.bonus = params.bonus.slice(0, i)
                    }
                }
            }
            ...
            if (m) {
                ...
                if (/\bptr\d*\b/.test(domain)) {
                    ...
                    if (/\bbeta\d*\b/.test(domain) || /\bwod\b/.test(domain)) {
                        locale = "beta"
                    }
                }
                ...
                var typeName = m[i1];
                if (isHearthhead && $WH.in_array(["achievement", "quest"], typeName) >= 0) {
                    typeName = "hs" + typeName
                }
                var type = $WH.g_getIdFromTypeName(typeName),
                    typeId = m[i2];
        ...
        function request(type, id, locale, stealth, params) {
            ...
            var p = "";
            for (var i in params) {
                if (i != "rand" && i != "ench" && i != "tink" && i != "gems" && i != "sock" && i != "diff" && i != "diffnew" && i != "upgd" && i != "chal" && i != "twtbc" && i != "twwotlk" && i != "pvp" && i != "lvl" && i != "bonus" && i != "q" && i != "level" && i != "abil" && i != "dd" && i != "ddsize") {
                    continue
                }
        ...
        function showTooltip(html, icon, map, spellData, html2, image, imageClass) {
            ...
            if (!html) {
                ...
                if (currentParams != null) {
                    if ($WH.g_reforgeStats && currentParams.forg && $WH.g_reforgeStats[currentParams.forg]) {
                    ...
                    if (currentParams.lvl) {
                        html = $WH.g_setTooltipLevel(html, (currentParams.lvl ? currentParams.lvl : 100), currentParams.buff)
                    }
            ...
            if ((!isRemote) && $WH.isset("g_user") && ("lists" in g_user) && $WH.isset("g_completion")) {
                ...
                if (complist && (currentType == TYPE_QUEST)) {
                    if (notFound || (html == _LANG.loading) || (LOOKUPS[currentType][0][currentId].hasOwnProperty("daily") && LOOKUPS[currentType][0][currentId]["daily"] != 0) || (LOOKUPS[currentType][0][currentId].hasOwnProperty("weekly") && LOOKUPS[currentType][0][currentId]["weekly"] != 0)) {
                        complist = false
                    }
                }
                var showBlanks = !(complist && (currentType in g_completion_categories) && ($WH.in_array(g_completion_categories[currentType], LOOKUPS[currentType][0][currentId].completion_category) == -1));
                if (complist) {
                    for (var c in g_user.lists) {
                        ...
                        var completed = ($WH.in_array(complist[l.id], compId) != -1);
            ...
            if ((!isRemote) && (currentType == TYPE_HEARTHSTONECARD) && $WH.isset("g_completion") && ("hearthstonecard" in g_completion) && LOOKUPS[currentType][0][currentId].collectible) {
                var ccomp = g_completion.hearthstonecard.hasOwnProperty(currentId) ? g_completion.hearthstonecard[currentId] : {
                    normal: 0,
                    golden: 0
                };
                var comphtml = '<div class="q hearthhead-my-collection">' + window.LANG.lvmycollection + window.LANG.colon + '<span class="hearthhead-card-normal q' + (ccomp.normal < 2 ? ccomp.normal : "") + '">' + ccomp.normal + '</span> <span class="hearthhead-card-gold q' + (ccomp.golden < 2 ? ccomp.golden : "") + '">' + ccomp.golden + "</span></div>";
            ...
            if ((!isRemote) && (currentType == TYPE_TRANSMOGSET) && (typeof ts_GetPreferredRace != "undefined")) {
                var trg = ts_GetPreferredRace();
        ...
        function getFullId(id, params) {
            return id + (params.rand ? "r" + params.rand : "") + (params.ench ? "e" + params.ench : "") + (params.gems ? "g" + params.gems.join(",") : "") + (params.sock ? "s" : "") + (params.upgd ? "u" + params.upgd : "") + (params.chal ? "chal" : "") + (params.twtbc ? "twtbc" : "") + (params.twwotlk ? "twwotlk" : "") + (params.lvl ? "lvl" + params.lvl : "") + (params.tink ? "tink" + params.tink : "") + (params.pvp ? "pvp" : "") + (params.bonus ? "b" + params.bonus.join(",") : "") + (params.q ? "q" + params.q : "") + (params.level ? "level" + params.level : "") + (params.abil ? "abil" + params.abil.join(",") : "") + (params.dd ? "dd" + params.dd : "") + (params.ddsize ? "ddsize" + params.ddsize : "")
        }
        this.clearTouchTooltip = function() {
        ...
        function getImageOverride(type, id) {
            ...
            if (arr[id]["screenshot"]) {
                return ["//wowimg.zamimg.com/uploads/screenshots/normal/" + arr[id]["screenshot"] + ".jpg", "screenshot"]
            }
            return false
        }
        ...
        this.registerGarrisonAbility = function(id, locale, json) {
            this.register(TYPE_GARRISONABILITY, id, locale, json)
        };
        ...
        this.registerHearthstoneMechanic = function(id, locale, json) {
            this.register(TYPE_HEARTHSTONEMECHANIC, id, locale, json)
        };
        this.registerHearthstoneAchievement = function(id, locale, json) {
            this.register(TYPE_HEARTHSTONEACHIEVEMENT, id, locale, json)
        };
        this.registerHearthstoneQuest = function(id, locale, json) {
            this.register(TYPE_HEARTHSTONEQUEST, id, locale, json)
        };
        this.registerHearthstoneCardBack = function(id, locale, json) {
            this.register(TYPE_HEARTHSTONECARDBACK, id, locale, json)
        };
        this.registerHearthstoneAdventure = function(id, locale, json) {
            this.register(TYPE_HEARTHSTONEADVENTURE, id, locale, json)
        };
        this.registerHearthstoneBoss = function(id, locale, json) {
            this.register(TYPE_HEARTHSTONEBOSS, id, locale, json)
        };
